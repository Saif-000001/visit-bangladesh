...
function Header() {
  ...
  const navLinks = (
    <>
      ...
      >
        <div onClick={handleBangladeshDropdownToggle}>
          Bangladesh
        </div>
        <ul
        ...
        >
          <li>
            <NavLink to={`/districts/${1}`}>Barisal</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${2}`}>Chittagong</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${3}`}>Dhaka</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${4}`}>Khulna</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${5}`}>Mymensingh</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${6}`}>Rajshahi</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${7}`}>Rangpur</NavLink>
          </li>
          <li>
            <NavLink to={`/districts/${8}`}>Sylhet</NavLink>
          </li>
        </ul>
      </li>
      <li>
        <div to="/corporate">Corporate</div>
      </li>
      <li>
      ...
      >
        <div to="/footer" onClick={handleFollowUsDropdownToggle}>
          Follow us
        </div>
        <ul
          className={`p-4 lg:absolute lg:top-full lg:left-0 lg:bg-orange-400 lg:shadow-lg lg:rounded-lg ${
